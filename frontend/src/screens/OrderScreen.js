...
const OrderScreen = () => {
  ...
  useEffect(() => {
    ...
    if (orderPaySuccess || !order || order._id !== orderId || orderDeliverState?.success) {
  ...
  }, [dispatch, order, orderId, orderPaySuccess, orderDeliverState?.success]);
        ...
        <Col md={4}>
          <Card>
            <ListGroup variant="flush">
              ...
              {orderDeliverState?.loading && <Loader />}
